...
class WeisseModelBase extends Model {
  ...
  var cell = new WeisseCellBase(
    Kp, thetar, k_cm, wr, wq, we, Kq, thetax, wp, gmax, M, vt, Kt, s0, vm, Km, ns, nq, nr, nx, dm, cl, kb, ku
  )
